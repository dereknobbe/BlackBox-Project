        ...
        if (difficulty.equals("quit")) {
            ...
            if (difficulty.equals("easy")) {
                while (difficulty.equals("easy")) {
                    ...
                    game.printbox();
                    System.out.println();
                    System.out.println("Deflection Method Tests");
                    System.out.println(game.deflectionCheck(1,1));
                    System.out.println();
                    ...
                    System.out.println();
                    System.out.println(game.deflectionCheck(1,6));
                    System.out.println();
                    System.out.println(game.deflectionCheck(1,7));
                    System.out.println();
